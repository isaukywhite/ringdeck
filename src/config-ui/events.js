...
function updateIconInUI(iconDataUrl, idx) {
...
export async function handleBrowseClick(s, idx) {
  ...
  if (iconDataUrl) {
    ...
    updateIconInUI(iconDataUrl, idx);
  }
}
...
export function bindEvents() {
  ...
  document.getElementById("telemetry-checkbox").addEventListener("change", (e) => {
    ...
    globalThis.api.setTelemetryConsent(getSentryEnabled());
  });
  ...
  // Delete profile from tab x button
